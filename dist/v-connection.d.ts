...
export declare type ElementId = InternalElementId | ExternalElementId;
export declare function isInternalElement(elementId: ElementId): elementId is InternalElementId;
export declare function isExternalElement(elementId: ElementId): elementId is ExternalElementId;
/**
...
//# sourceMappingURL=v-connection.d.ts.map